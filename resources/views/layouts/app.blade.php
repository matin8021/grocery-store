                ...
                <div class="container">
                    ...
                    @guest
                            ...
                            @endif
                             @if (Route::has('login'))
                                <li class="nav-item">
                                <a href="{{route('login')}}" class="nav-link">وارد شدن</a>
                            </li>
                            @endif
                            @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{route('users.orders')}}">تاریخچه معاملات</a>
                                    <a class="dropdown-item" href="{{route('users.settings')}}">تنظیمات</a>
